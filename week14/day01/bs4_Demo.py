...
# print(list(a.attrs["href"] for a in bsp.select('a')))
# 所有属性 非空 的 div 元素集合列表
# print(list(p for p in bsp.select('div') if p.attrs))
# 所有属性为 空 的 div 元素集合列表
print(list(p for p in bsp.select('div') if not p.attrs))
