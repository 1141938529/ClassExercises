...
# 全局初始化
from demos.myplane.Bullet import Bullet
from demos.myplane.Button import PauseButton
from demos.myplane.Enemy import SmallEnemy
from demos.myplane.Hero import Hero
